...
Df_O3.to_hdf('O3data.h5','O3',append=True)
Df_O3_Err.to_hdf('O3data.h5','O3Err',append=True)
Df_TH.to_hdf('O3data.h5','TH',append=True)
Df_Ext386.to_hdf('O3data.h5','Ext386',append=True)
Df_Ext452.to_hdf('O3data.h5','Ext386',append=True)
Df_Ext525.to_hdf('O3data.h5','Ext386',append=True)
Df_Ext1020.to_hdf('O3data.h5','Ext386',append=True)
Df_Ext386_Err.to_hdf('O3data.h5','Ext386_Err',append=True)
Df_Ext452_Err.to_hdf('O3data.h5','Ext452_Err',append=True)
Df_Ext525_Err.to_hdf('O3data.h5','Ext525_Err',append=True)
Df_Ext1020_Err.to_hdf('O3data.h5','Ext1020_Err',append=True)
